...
Mesh::ProcessData::ProcessData(uint32_t idx){
    process_id = idx;
}

void Mesh::ProcessData::print_data(std::string file_name) {
    ...
    for (auto& element : element_list) {
        ...
        outfile << "Domain_id:" << std::endl;
        outfile << element.domain_id << std::endl;
        outfile << "Owner_CPU:" << std::endl;
        outfile << element.owner_cpu << std::endl;

        outfile << "inflat:" << std::endl;
        outfile << element.inflat << std::endl;

        outfile << "theta:" << std::endl;
        outfile << element.theta1 << "," << element.theta2 << std::endl;

        outfile << "r:" << std::endl;
        outfile << element.r1 << "," << element.r2 << std::endl;

        outfile << "rx:" << std::endl;
        outfile << element.rx1 << "," << element.rx2 << std::endl;

        outfile << "rz:" << std::endl;
        outfile << element.rz1 << "," << element.rz2 << std::endl;

        outfile << "rad0, rad1:" << std::endl;
        outfile << element.rad0 << "," << element.rad1 << std::endl;

        outfile << "coeff:" << std::endl;
        outfile << element.coeff << std::endl;

        outfile << "npart:" << std::endl;
        outfile << element.npart << std::endl;
...
void Mesh::ProcessData::read_data(std::string file_name) {
